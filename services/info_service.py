...
def make_preview_image_file(font_config):
    ...
    image = Image.new('RGBA', (font_config.line_height_px * 35, font_config.px * 2 + font_config.line_height_px * 10), (255, 255, 255))
    ...
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px), '我们每天度过的称之为日常的生活，其实是一个个奇迹的连续也说不定。', fill=(0, 0, 0), font=image_fonts['monospaced']['zh_cn'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 2), '我們每天度過的稱之為日常的生活，其實是一個個奇跡的連續也說不定。', fill=(0, 0, 0), font=image_fonts['monospaced']['zh_hk'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 3), '日々、私たちが過ごしている日常は、実は奇跡の連続なのかもしれない。', fill=(0, 0, 0), font=image_fonts['monospaced']['ja'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 4), 'THE QUICK BROWN FOX JUMPS OVER A LAZY DOG.', fill=(0, 0, 0), font=image_fonts['monospaced']['zh_cn'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 5), 'the quick brown fox jumps over a lazy dog.', fill=(0, 0, 0), font=image_fonts['monospaced']['zh_cn'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 6), 'THE QUICK BROWN FOX JUMPS OVER A LAZY DOG.', fill=(0, 0, 0), font=image_fonts['proportional']['zh_cn'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 7), 'the quick brown fox jumps over a lazy dog.', fill=(0, 0, 0), font=image_fonts['proportional']['zh_cn'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 8), '0123456789', fill=(0, 0, 0), font=image_fonts['monospaced']['zh_cn'])
    ImageDraw.Draw(image).text((font_config.px, font_config.px + font_config.line_height_px * 9), '★☆☺☹♠♡♢♣♤♥♦♧☀☼♩♪♫♬☂☁⚓✈⚔☯☎☏', fill=(0, 0, 0), font=image_fonts['monospaced']['zh_cn'])
